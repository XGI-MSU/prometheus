...
This package is hosted in a **private GitHub repository** under the
`access-prometheus` organization. You must be a member of the organization
and have SSH access to GitHub.
